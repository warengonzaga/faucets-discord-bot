# 🎯 Contributing to Faucets (Discord Bot)
...
This project and everyone participating in it is governed by the Faucets (Discord Bot) [Code of Conduct](https://github.com/warengonzaga/faucets-discord-bot/blob/master/CODE_OF_CONDUCT.md). By participating, you are expected to uphold this code. Please report unacceptable behavior to <opensource@warengonzaga.com>.
